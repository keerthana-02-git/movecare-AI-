...
function GoogleAuthButton({ onAuthComplete, onError, disabled }) {
  ...
  const handleSelectAccount = async (email, name) => {
    ...
    const sanitizedName = name || sanitizedEmail.split('@')[0].replace(/[._]/g, ' ')
    await submitGoogleToken(`test-google-token:${sanitizedEmail}:${sanitizedName}:google-sub-${Date.now()}`)
  }
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
              <svg viewBox="0 0 24 24" width="32" height="32" style={{ marginBottom: '0.75rem' }}>
                <path
                  fill="#4285F4"
                  d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                />
              ...
              <h2 style={{ fontSize: '1.35rem', fontWeight: 600, color: '#1e293b', margin: '0 0 0.25rem' }}>
                Choose an account
              </h2>
              <p style={{ fontSize: '0.9rem', color: '#64748b', margin: 0 }}>
                to continue to <strong style={{ color: '#0f172a' }}>MoveCare AI</strong>
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
              ...
              <button
                type="button"
                onClick={() => handleSelectAccount('keerthana.r.cse.2024@snsce.ac.in', 'Keerthana')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '1rem',
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontWeight: 600, color: '#1e293b', fontSize: '0.95rem' }}>Keerthana</div>
                  <div style={{ color: '#64748b', fontSize: '0.82rem', textOverflow: 'ellipsis', overflow: 'hidden' }}>
                    keerthana.r.cse.2024@snsce.ac.in
                  </div>
                </div>
              </button>

              {/* Toggle another account */}
              {!useAnotherAccount ? (
                <button
                  type="button"
                ...
                >
                  <label style={{ fontSize: '0.82rem', color: '#475569', fontWeight: 500 }}>
                    Google Email:
                  </label>
                  <input
                    type="email"
